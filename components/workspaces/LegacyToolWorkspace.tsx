...
// Each tool's interactive logic lives in this component for now.
// To add a new tool:
// 1. Register its metadata in lib/tools/definitions/<tool>.ts.
// 2. Add a UI block keyed by tool.id below, alongside any state or handlers it needs.
// Keeping the ID-scoped sections grouped helps contributors extend the workspace without
// touching unrelated tools.
export function LegacyToolWorkspace({ tool }: { tool: ToolInfo }) {
